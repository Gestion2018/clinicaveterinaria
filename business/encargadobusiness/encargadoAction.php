...
if (isset($_POST['actualizar'])) {
    ...
    if (isset($_POST['encargadoId']) && isset($_POST['encargadoNombreCompleto']) && isset($_POST['encargadoDireccion']) && isset($_POST['encargadoEstado'])) {
        ...
        if (strlen($encargadoNombreCompleto) > 0 && strlen($encargadoDireccion) > 0) {
            if (!is_numeric($encargadoNombreCompleto)) {
                $encargado = new encargado($encargadoId, $encargadoNombreCompleto, 0, $encargadoDireccion, $encargadoEstado);
    ...
    if (isset($_POST['encargadoNombreCompleto']) && isset($_POST['encargadoTelefonos']) && isset($_POST['encargadoDireccion']) && isset($_POST['encargadoEstado'])) {
        ...
        if (strlen($encargadoNombreCompleto) > 0 && strlen($encargadoDireccion) > 0) {
            if (!is_numeric($encargadoNombreCompleto)) {
                ...
                $encargado = new encargado(0, $encargadoNombreCompleto, $encargadoTelefono, $encargadoDireccion, $encargadoEstado);
