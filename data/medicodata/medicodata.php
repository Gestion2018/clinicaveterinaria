...
class MedicoData extends Data {

	public function insertarMedico($medico) {
    
        $conn = mysqli_connect($this->server, $this->user, $this->password, $this->db);
        $conn->set_charset('utf8');

        //Get the last id
        $queryGetLastId = "SELECT MAX(medicoid) AS medicoid  FROM tbmedico";
        ...
        $queryInsert = "INSERT INTO tbmedico VALUES (" . $nextId . "," .
